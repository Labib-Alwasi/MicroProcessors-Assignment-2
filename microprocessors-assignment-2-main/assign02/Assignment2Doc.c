...
char *set_input_array[256]; ///< brief description
...
struct words_hash_table *hashArray[20]; ///< brief description
struct words_hash_table *item; ///< brief description
 ...
 *  @{
 */
absolute_time_t start_time; ///< brief description
int level_number; ///< brief description
int lives; ///< brief description
char level_selection[5]; ///< brief description
bool game_status = false; ///< brief description
/**
 ...
 * Checks patterns
 * 
 * @param level_number info
 * @param given_char info
 * @param morse_code_input info               
 */
int check_pattern(int level_number, char *given_char, char *morse_code_input)
{
    switch (level_number)
